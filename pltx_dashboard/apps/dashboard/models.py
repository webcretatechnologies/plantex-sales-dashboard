...
class FlipkartSearchTraffic(models.Model):
    ...
    user = models.ForeignKey('accounts.Users', on_delete=models.CASCADE, related_name='fk_search_traffic')
...
class FlipkartCategoryMap(models.Model):
    ...
    user = models.ForeignKey('accounts.Users', on_delete=models.CASCADE, related_name='fk_category_maps')
    fsn = models.CharField(max_length=50, db_index=True)
    sku = models.CharField(max_length=100, null=True, blank=True)
...
class FlipkartPrice(models.Model):
    ...
    user = models.ForeignKey('accounts.Users', on_delete=models.CASCADE, related_name='fk_price_data')
    fsn = models.CharField(max_length=50, db_index=True)
    price = models.FloatField(default=0.0)
...
class FlipkartPCA(models.Model):
    ...
    user = models.ForeignKey('accounts.Users', on_delete=models.CASCADE, related_name='fk_pca_reports')
...
class FlipkartPLA(models.Model):
    ...
    user = models.ForeignKey('accounts.Users', on_delete=models.CASCADE, related_name='fk_pla_reports')
    campaign_id = models.CharField(max_length=100, db_index=True)
    fsn_id = models.CharField(max_length=100, db_index=True)
...
class FlipkartSalesInvoice(models.Model):
    ...
    user = models.ForeignKey('accounts.Users', on_delete=models.CASCADE, related_name='fk_sales_invoices')
...
class FlipkartCoupon(models.Model):
    ...
    user = models.ForeignKey('accounts.Users', on_delete=models.CASCADE, related_name='fk_coupon_data')
    fsn = models.CharField(max_length=50, db_index=True)
...
class FlipkartProcessedDashboardData(models.Model):
    ...
    user = models.ForeignKey('accounts.Users', on_delete=models.CASCADE, related_name='fk_processed_dashboard')
    date = models.DateField(db_index=True)
    fsn = models.CharField(max_length=50, db_index=True)
    ...
    total_spend = models.FloatField(default=0.0)
    spend_sp = models.FloatField(default=0.0)      # not split for Flipkart; all in total_spend
    spend_sb = models.FloatField(default=0.0)
    spend_sd = models.FloatField(default=0.0)
