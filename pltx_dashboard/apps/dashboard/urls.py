...
urlpatterns = [
    path('', RedirectView.as_view(pattern_name='dashboard-home', permanent=False), name='root-redirect'),
    ...
    path('dashboard/download/<str:file_format>/', download_calculated_data, name='dashboard-download'),
]
