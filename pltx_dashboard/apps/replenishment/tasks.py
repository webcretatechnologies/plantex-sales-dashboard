    ...
    try:
        ...
        try:
            ...
            annexure_data = [
                {
                    "Header Name": "BSR",
                    "Description / Formula": "Best Seller Rank of the product.",
                },
                {
                    "Header Name": "ASIN",
                    "Description / Formula": "Amazon Standard Identification Number.",
                },
                {
                    "Header Name": "Ideal Cluster",
                    "Description / Formula": "Optimized fulfillment cluster identified for this ASIN.",
                },
                {
                    "Header Name": "SKU",
                    "Description / Formula": "Stock Keeping Unit from product details.",
                },
                {
                    "Header Name": "HSN CODE",
                    "Description / Formula": "Harmonized System of Nomenclature code.",
                },
                {
                    "Header Name": "VENDOR NAME",
                    "Description / Formula": "Name of the supplier or vendor.",
                },
                {
                    "Header Name": "PRODUCTS STATUS",
                    "Description / Formula": "Current operational status of the product.",
                },
                {
                    "Header Name": "ACT WEIGHT",
                    "Description / Formula": "Actual physical weight of the product.",
                },
                {
                    "Header Name": "VOLUMETRIC WEIGHT",
                    "Description / Formula": "Volumetric weight based on product dimensions.",
                },
                {
                    "Header Name": "PRODUCT TYPE",
                    "Description / Formula": "Classification type of the product.",
                },
                {
                    "Header Name": "PRODUCT SIZE",
                    "Description / Formula": "Size category of the product.",
                },
                {
                    "Header Name": "Portfolio",
                    "Description / Formula": "Product portfolio group.",
                },
                {
                    "Header Name": "Category",
                    "Description / Formula": "Product category.",
                },
                {
                    "Header Name": "Zone",
                    "Description / Formula": "Demand zone derived from sales data.",
                },
                {
                    "Header Name": "LIS_CLUSTER",
                    "Description / Formula": "Mapped Local In-Stock cluster.",
                },
                {
                    "Header Name": "DRR",
                    "Description / Formula": "Daily Run Rate (average daily sales).",
                },
                {
                    "Header Name": "Sales Qty",
                    "Description / Formula": "Total sales quantity for the period.",
                },
                {
                    "Header Name": "Stock Qty",
                    "Description / Formula": "Current available stock quantity in warehouse.",
                },
                {
                    "Header Name": "Receiving Qty",
                    "Description / Formula": "Quantity currently in 'Receiving' status across DFC and IXD shipments.",
                },
                {
                    "Header Name": "Stock Transfer Qty",
                    "Description / Formula": "Stock in transit between warehouses (from stock report).",
                },
                {
                    "Header Name": "Shipment Qty",
                    "Description / Formula": "Total quantity in upcoming and pending DFC shipments (Pending + Upcoming + Intransit).",
                },
                {
                    "Header Name": "P0",
                    "Description / Formula": "Formula: DRR * 15 - Stock Qty - Receiving Qty - Stock Transfer Qty - Shipment Qty",
                },
                {
                    "Header Name": "P1",
                    "Description / Formula": "Formula: DRR * 30 - Stock Qty - Receiving Qty - Stock Transfer Qty - Shipment Qty - P0",
                },
                {
                    "Header Name": "P2",
                    "Description / Formula": "Formula: DRR * 60 - Stock Qty - Receiving Qty - Stock Transfer Qty - Shipment Qty - P1 - P0",
                },
                {
                    "Header Name": "Stock Out Date",
                    "Description / Formula": "Formula: IF(Today+((Stock Qty + Receiving Qty)/DRR) > Shipment Date, Today+((Stock Qty + Shipment Qty + Receiving Qty)/DRR), Today+((Stock Qty + Receiving Qty)/DRR))",
                },
                {
                    "Header Name": "Stock cover alert",
                    "Description / Formula": "Alert category based on Days of Cover (<30, Healthy, >120 Days, etc).",
                },
                {
                    "Header Name": "Page Views - Total",
                    "Description / Formula": "Total page views from the business report.",
                },
                {
                    "Header Name": "Units Ordered",
                    "Description / Formula": "Total units ordered from the business report.",
                },
                {
                    "Header Name": "Total Order Items",
                    "Description / Formula": "Total order items from the business report.",
                },
                {
                    "Header Name": "Conversion Pct",
                    "Description / Formula": "Formula: (Total Order Items / Page Views - Total) * 100",
                },
                {
                    "Header Name": "Ordered Product Sales",
                    "Description / Formula": "Total sales value from orders.",
                },
                {
                    "Header Name": "LIS_LOCAL_QTY",
                    "Description / Formula": "Local shipped units within the LIS cluster.",
                },
                {
                    "Header Name": "LIS_TOTAL_QTY",
                    "Description / Formula": "Total shipped units within the LIS cluster.",
                },
                {
                    "Header Name": "DFC Appointment Pending Qty",
                    "Description / Formula": "Quantity in DFC shipments pending appointment.",
                },
                {
                    "Header Name": "DFC Upcoming Shipment Qty",
                    "Description / Formula": "Quantity in upcoming DFC shipments.",
                },
                {
                    "Header Name": "DFC Intransit Qty",
                    "Description / Formula": "Quantity currently in transit for DFC shipments.",
                },
                {
                    "Header Name": "DFC Shipment ID",
                    "Description / Formula": "Shipment IDs for DFC replenishment.",
                },
                {
                    "Header Name": "DFC Next Arrival Date",
                    "Description / Formula": "Earliest arrival date for upcoming DFC shipments.",
                },
                {
                    "Header Name": "IXD Appointment Pending Qty",
                    "Description / Formula": "Quantity in IXD shipments pending appointment.",
                },
                {
                    "Header Name": "IXD Upcoming Shipment Qty",
                    "Description / Formula": "Quantity in upcoming IXD shipments.",
                },
                {
                    "Header Name": "IXD Receiving + Intransit Qty",
                    "Description / Formula": "Quantity currently receiving or in transit for IXD shipments.",
                },
                {
                    "Header Name": "IXD Shipment ID",
                    "Description / Formula": "Shipment IDs for IXD replenishment.",
                },
            ]
